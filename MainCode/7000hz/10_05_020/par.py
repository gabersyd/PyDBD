...
#____________________________________________________________________________________
width=0.1						 #space between two dielectric in mm
volt=9000.0					 #Interelectrode voltage (peak not RMS)
frequencySource =  1000	 #Frequncy of the voltage source in Hz
...
#np.savetxt('output/parameters'+str(rank)+'.txt',np.array([newloc,ngrid0,ngrid,cyclescompleted]))
