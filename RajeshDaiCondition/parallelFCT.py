...
datapercycle = 500							# how many data per cycle to record
datapercycle1 = 500							# how many data per cycle to record
...
try:
	while time<totaltime:# and elapsed<0.1 :
		...
		#-----------------------------------------------------------------------------------------------
		if (save == 1):
			np.savetxt(f"output/ndensity_{newloc}.dat", ndensity, fmt="%.6e")
			np.savetxt(f"output/ncharge_{newloc}.dat", ncharge, fmt="%.6e")
			np.savetxt(f"output/gMat_{newloc}.dat", gMat, fmt="%.6e")
			np.savetxt(f"output/dMat_{newloc}.dat", dMat, fmt="%.6e")
			np.savetxt(f"output/netcharge_{newloc}.dat", netcharge, fmt="%.6e")
			np.savetxt(f"output/potentl_{newloc}.dat", potentl, fmt="%.6e")
			np.savetxt(f"output/efield_{newloc}.dat", efield, fmt="%.6e")
